...
const Upload = () => {
    ...
    const party_1_r = useRef();
    const party_2_r = useRef();
    const date_r = useRef();
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-4">
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            placeholder="Enter Case Number"
                            onChange={() => {
                                console.log(party_1_r.current.value);
                            }}
                        />
                    </div>
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            placeholder="Enter Case Number"
                            onChange={() => {
                                console.log(party_2_r.current.value);
                            }}
                        />
                    </div>
                </div>
                <div className="flex flex-col">
                    ...
                    <input
                        ...
                        placeholder="Enter Case Number"
                        onChange={() => {
                            console.log(date_r.current.value);
                        }}
                        type="date"
                    />
                </div>
            </div>
            <button className="px-2 py-4 bg-black rounded-xl text-xl font-bold">
                Upload
            </button>
        </div>
    );
